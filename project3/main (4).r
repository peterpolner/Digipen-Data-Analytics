...
boxplot(EWData, ylab= "Days", main= "Extreme Weather Events per Year", density=50, col="cadetblue3", ylim = c(0,60))
text(x= 1, y= 5, labels = "2015")
text(x= 1, y= 51, labels = "1962")

#16. Creates Histogram of avarage wind speeds
WS <- OUCD$V
print(OUCD$V)
hist(WS, main = "Histogram of Avarage Wind Speeds", xlab="Avarage Wind speeds", plot = TRUE, axes = TRUE,xaxp = c(10, 20, 10), xlim = range(10:11, 11:12, 12:13, 13:14, 14:15, 15:16, 16:17, 17:18, 18:19, 19:20))
...
gradient <- colorRampPalette(c("lightblue", "blue"))(length(bgx))

barplot(bgy, names.arg = bgx, main = "Amount of Rainy Days by Year", ylab = "Avarage rainy days", xlab = "Year", col = gradient )
